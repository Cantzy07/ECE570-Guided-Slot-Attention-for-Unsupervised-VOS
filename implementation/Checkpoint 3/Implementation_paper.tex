...
=
\left\{
  \frac{X_L(x,y) \cdot \mathbf{P}_S_r^i}
       {\|X_L(x,y)\|\;\|\mathbf{P}_S_r^i\|}
\right\}_{m}.
\end{align}
...
\hline
\textbf{Method} & \textbf{Publication} & \textbf{backbone} & \textbf{Resolution} & \textbf{OF} & \textbf{PP} & \textbf{FPS} & $\mathcal{G_M}$ & $\mathcal{J_M}$ & $\mathcal{F_M}$ \\ \hline
MATNet \cite{38} & AAAI'20 & ResNet101 & 473$\times$473 & \checkmark & & 20.0 & 81.6 & 82.4 & 80.7 \\
WCS-Net \cite{36} & ECCV'20 & EfficientNetV2 & 320$\times$320 & \checkmark & & 33.3 & 81.5 & 82.2 & 80.7 \\
DFNet \cite{37} & ECCV'20 & DeepLabV3 & - & & & 3.57 & 82.6 & 83.4 & 81.8 \\
F2Net \cite{13} & AAAI'21 & DeepLabV3 & 473$\times$473 & \checkmark & & 10.0 & 83.7 & 83.1 & 84.4 \\
RTNet \cite{22} & CVPR'21 & ResNet101 & 384$\times$672 & \checkmark & & - & 85.2 & 85.6 & 84.7 \\
FSNet \cite{7} & ICCV'21 & ResNet50 & 352$\times$352 & \checkmark & & 12.5 & 83.3 & 83.4 & 83.1 \\
TransportNet \cite{35} & ICCV'21 & ResNet101 & 512$\times$512 & \checkmark & & 12.5 & 84.8 & 84.5 & 85.0 \\
AMC-Net \cite{33} & ICCV'21 & ResNet101 & 384$\times$384 & & & 17.5 & 84.6 & 84.5 & 84.6 \\
IMP \cite{10} & AAAI'22 & ResNet50 & - & & & 1.79 & 85.3 & 84.5 & 86.0 \\
HFAN \cite{19} & ECCV'22 & ResNet101 & 512$\times$512 & \checkmark & & 19.0 & 87.0 & 86.7 & 87.3 \\
HFAN \cite{19} & ECCV'22 & ResNet101 & 512$\times$512 & \checkmark & \checkmark & 2.5 & 88.0 & 87.5 & 88.6 \\
HFAN \cite{19} & ECCV'22 & MiT-b2 & 512$\times$512 & \checkmark & & 18.4 & 87.6 & 87.0 & 88.1 \\
HFAN* \cite{19} & ECCV'22 & MiT-b2 & 512$\times$512 & \checkmark & \checkmark & 2.9 & 88.7 & 88.0 & 89.3 \\
PMN \cite{9} & WACV'23 & VGG16 & 448$\times$256 & \checkmark & & - & 85.9 & 85.4 & 86.4 \\
TMO \cite{3} & WACV'23 & ResNet101 & 384$\times$384 & \checkmark & & \textbf{43.2} & 86.1 & 85.6 & 86.6 \\
OAST \cite{24} & ICCV'23 & MiT-b2 & 512$\times$512 & \checkmark & & - & 87.0 & 86.6 & 87.4 \\ \hline
\textbf{GSANet} & & ResNet101 & 512$\times$512 & \checkmark & & 41.5 & 87.7 & 87.0 & 88.4 \\
\textbf{GSANet*} & & ResNet101 & 512$\times$512 & \checkmark & \checkmark & 4.5 & 88.4 & 87.9 & 89.0 \\
\textbf{GSANet} & & MiT-b2 & 512$\times$512 & \checkmark & & 38.2 & 88.2 & 87.4 & 89.0 \\
\textbf{GSANet*} & & MiT-b2 & 512$\times$512 & \checkmark & \checkmark & 4.1 & \textbf{88.9} & \textbf{88.3} & \textbf{89.6} \\
\textbf{Re-Implementation} & & MiT-b2 & 480$\times$480 & \checkmark & \checkmark & fps & \textbf{data} & \textbf{data} & \textbf{data} \\ \hline
\end{tabular}%
}
\label{tab:davis16}
